...
def normalize_vector(vector):
    return data.Vector(vector.x / math.sqrt(vector.x ** 2 + vector.y ** 2),
                       vector.y / math.sqrt(vector.x ** 2 + vector.y ** 2),
                       vector.z / math.sqrt(vector.x ** 2 + vector.y ** 2))


def difference_point(point1, point2):
    return data.Point(point1.x - point2.x, point1.y - point2.y, point1.z - point2.z)
